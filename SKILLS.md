...
| [repo-aware](skills/repo-aware/SKILL.md) | Use when working inside an existing repository and the user wants AI to inspect, reason, plan, review, or implement changes with repo-specific context. Guides Codex to combine local files, repo-signal reports, project conventions, Git state, docs, tests, release flow, and AI-readiness signals before acting. |
