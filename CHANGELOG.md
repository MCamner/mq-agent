...
- 8 direct prompt commands wired into mqlaunch: `agent score`, `agent audit`, `agent doctor`, `agent release-check`, `agent review release`, `agent release-workflow`, `agent mcp-status`, `agent mcp-tools`
